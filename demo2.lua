...
local Fly = Tabs.Setting:AddButton("FlyUI", 
{
    Title = "Fly UI", 
    Description = "Need not to know"
    Callback = function(OpenUi) 
    if OpenUi then
...
local chest = Tabs.Misc:AddButton({
    Title = "Chest Farm",
    Description = "this is other Chest Farm Hub",
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/hoangnorpscripter/Cat-W-VNSea/main/ChestHub.lua"))()
    end
})
